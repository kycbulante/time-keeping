...
$pperiodquery = "SELECT * FROM payperiods WHERE payperiod_ID = '$payperiod'";
  ...
  error_log($pperiodquery);
      ...
      if ($pperiodarray){
        ...
        $searchquery .= " AND DTR.DTR_DAY BETWEEN '" . $_SESSION['payperiodfrom'] . "' AND '" . $_SESSION['payperiodto'] . "'";
...
$searchquery .= " GROUP BY employees.emp_id ORDER BY dtr.emp_id ASC LIMIT $start_from, $results_perpage";
        ...
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs" id="myTab">
              ...
              <li class="active"><a href="adminDTR.php"><i class="icon-time"></i> Daily Time Record</a></li>
...
<div class ="span5">
        ...
        <a href="printalldtr.php" class="btn btn-primary">Print displayed</a>
    </div>
<div class = "span5">
...
<div class = "span5">
<a href="adminDTR.php?refresh=true" class="btn btn-success" style="float:right; margin-left: 4px;">
    <span class="icon"><i class="icon-refresh"></i></span> Refresh
</a>
              </div>
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
              ...
              <tbody> 
               ...
               ?> 
                  ...
                  <td><center><a href = "adminPRINTdtr.php?id=<?php echo $row1['emp_id']; ?>" class = "btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print</a>
