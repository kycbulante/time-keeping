...
<div id="content">
  ...
  <div id="content-header">
    ...
    <div id="breadcrumb"> <a href="adminDASHBOARD.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href ="adminMasterfile.php" class="tip-bottom"><i class ="icon-file"></i> Employee Masterlist</a></div>
  </div>
...
<div class ="span1">
    ...
    <a href="printmasterlist.php?printAll" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print All Masterlist</a>
    <a href="printmasterlist.php?printDisplayed" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print Displayed Masterlist</a>
        ...
        <div class="widget-box">
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
              ...
              <div class = "row-fluid">
                <div class = "span2">
                  <div id ="search">
                    <!-- <form action="adminMasterfile.php" method = "post">
                ...
                <div class = "span2">
                  <div class="radio">
                    <label class="radio-inline" for="eiradio"><input type="radio" name="searchoption" id="eiradio" value="Employee ID">Employee ID</label>
                ...
                <div class = "span6">
                  <a href ="adminMasterfile.php" class = "btn btn-success" style = "float:right; margin-left: 4px;"><span class="icon"><i class="icon-refresh"></i></span> Refresh</a>
                  <a href ="adminADDprofile.php" class = "btn btn-info" style = "float:right;"><span class="icon"><i class="icon-plus"></i></span> Add Profile</a>
                  <a href ="./biometricattendance1/ManageUsers.php" class = "btn btn-info" style = "float:right;"><span class="icon"><i class="icon-plus"></i></span> Add Fingerprint</a>
                </div>
              ...
              <tbody> 
               ...
               ?>
                  ...
                  <td><?php echo $row1['fingerprint_id'];?></td>
                  ...
                  <td><center><a href = "adminEDITMasterfile.php?id=<?php echo $row1['emp_id']; ?>" class = "btn btn-info btn-mini"><span class="icon"><i class="icon-edit"></i></span> Edit</a>
                    <a href = "adminDELETEMasterfile.php?id=<?php echo $row1['emp_id'];?>" class = "btn btn-danger btn-mini"><span class="icon"><i class="icon-trash"></i></span> Delete</a></center></td>
