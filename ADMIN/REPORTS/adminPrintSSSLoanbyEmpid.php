...
$getemppayrec = "SELECT * FROM PAY_PER_PERIOD WHERE emp_id = '$govrepempid' AND pperiod_year = '$govrepyear' AND sssloan_deduct != '0.00'";
...
while ($check1array = mysqli_fetch_array($getemppayrecexec)):;
  ...
  $sssloan = $check1array['sssloan_deduct'];
