...
if (isset($_GET['printall'])) {
	$storedQuery = "SELECT * FROM employees JOIN pay_per_period ON employees.emp_id = pay_per_period.emp_id WHERE pay_per_period.pperiod_range = '$payperiodrange' ORDER BY PAY_PER_PERIOD.emp_id ASC";
