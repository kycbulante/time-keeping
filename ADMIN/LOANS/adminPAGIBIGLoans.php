...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href ="adminMasterfileDept.php" class="tip-bottom"><i class ="icon-th"></i> Pagibig Loans</a></div>
  </div>
...
<div class ="span1">
        ...
        <div class="modal-footer">
                      ...
                      <div class="container-fluid">
                      <a href="printpagibig.php?printAll" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print All Masterlist</a>
                      <a href="printpagibig.php?printDisplayed" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print Displayed Masterlist</a>
        ...
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs" id="myTab">
              ...
              <li class="active"><a href="../LOANS/adminPAGIBIGLoans.php"><i class="icon-th"></i> Pagibig Loans</a></li>
          ...
          <div id="tab1" class="tab-pane fade in active">
             <a href ="<?php $_SERVER['PHP_SELF'];?>" class = "btn btn-success" style = "float:right; margin-left: 4px;"><span class="icon"><i class="icon-refresh"></i></span> Refresh</a>
               <a href ="adminADDPAGIBIGLoan.php" class = "btn btn-info" style = "float:right;"><span class="icon"><i class="icon-plus"></i></span> Add GSIS Loan</a>
               <br>
               <br>
              ...
              <?php
               ...
               ?>
                  <tr class="gradeX">
                  <td><?php echo $row1DEPT['pagibig_idno']; ?></td>
                  ...
                  <td><?php echo $row1DEPT['loanstart_date']; ?></td>
                  <td><?php echo $row1DEPT['loanend_date']; ?></td>
