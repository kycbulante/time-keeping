...
if (isset($_GET['findTasks'])) {
  ...
  if (!empty($filterConditions)) {
    ...
    $searchquery = "SELECT * 
      ...
      $searchquery .= " ORDER BY time_keeping.emp_id ASC LIMIT $start_from, $results_perpage";
...
// Check if $search_result is empty or not defined
else {
  $start_from = ($page - 1) * $results_perpage;
  // If not defined or empty, perform a default query without filters
  $searchquery = "SELECT TIME_KEEPING.in_morning, TIME_KEEPING.out_afternoon, TIME_KEEPING.emp_id, TIME_KEEPING.timekeep_day, employees.* from employees, TIME_KEEPING  WHERE  employees.emp_id = TIME_KEEPING.emp_id";
      ...
      <form method="GET" action="">
        ...
        <ul class="nav nav-list">
          ...
          <!-- Add other sidebar items as needed -->
              ...
              <a href="printattendancerecords.php?printAll" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print All Masterlist</a>
    <a href="printattendancerecords.php?printDisplayed" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print Displayed Masterlist</a>
        ...
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs" id="myTab">
              <li class="active"><a href="#tab1"><i class="icon-calendar"></i> Records</a></li>
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
                ...
                <div class = "span5">
                  <a href ="adminATTENDANCErecords.php" class = "btn btn-success" style = "float:right; margin-left: 4px;"><span class="icon"><i class="icon-refresh"></i></span> Refresh</a>
