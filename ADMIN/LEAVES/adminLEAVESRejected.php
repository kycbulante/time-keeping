...
if(isset($_POST['search_btn'])){
  ...
  switch ($searchby) {
    ...
    case "Employee ID":
        ...
        $searchquery = "SELECT LEAVES_APPLICATION.*, employees.* from employees, LEAVES_APPLICATION  WHERE employees.emp_id LIKE '%$searchvalue%' AND LEAVES_APPLICATION.leave_status = 'Rejected' AND employees.emp_id = LEAVES_APPLICATION.emp_id ORDER BY LEAVES_APPLICATION.emp_id DESC LIMIT $start_from,".$results_perpage;  
    ...
    case "Last Name":
        ...
        $start_from = ($page-1) * $results_perpage;
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT LEAVES_APPLICATION.*, employees.* from employees, LEAVES_APPLICATION  WHERE employees.last_name LIKE '%$searchvalue%' AND LEAVES_APPLICATION.leave_status = 'Rejected' AND employees.emp_id = LEAVES_APPLICATION.emp_id ORDER BY LEAVES_APPLICATION.emp_id DESC LIMIT $start_from,".$results_perpage;  
        $search_result = filterTable($searchquery);
    ...
    break;
     ...
     case "First Name":
        ...
        $start_from = ($page-1) * $results_perpage;
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT LEAVES_APPLICATION.*, employees.* from employees, LEAVES_APPLICATION  WHERE employees.first_name LIKE '%$searchvalue%' AND LEAVES_APPLICATION.leave_status = 'Rejected' AND employees.emp_id = LEAVES_APPLICATION.emp_id ORDER BY LEAVES_APPLICATION.emp_id DESC LIMIT $start_from,".$results_perpage;  
        $search_result = filterTable($searchquery);
    ...
    case "Username":
        ...
        $start_from = ($page-1) * $results_perpage;
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT LEAVES_APPLICATION.*, employees.* from employees, LEAVES_APPLICATION  WHERE employees.user_name LIKE '%$searchvalue%' AND LEAVES_APPLICATION.leave_status = 'Rejected' AND employees.emp_id = LEAVES_APPLICATION.emp_id ORDER BY LEAVES_APPLICATION.emp_id DESC LIMIT $start_from,".$results_perpage;  
        $search_result = filterTable($searchquery);
    ...
    case "";
        ...
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT LEAVES_APPLICATION.*, employees.* from employees, LEAVES_APPLICATION  WHERE LEAVES_APPLICATION.leave_status = 'Rejected' AND employees.emp_id = LEAVES_APPLICATION.emp_id ORDER BY LEAVES_APPLICATION.emp_id";  
        $search_result = filterTable($searchquery);
    ...
    default:
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT LEAVES_APPLICATION.*, employees.* from employees, LEAVES_APPLICATION  WHERE LEAVES_APPLICATION.leave_status = 'Rejected' AND employees.emp_id = LEAVES_APPLICATION.emp_id ORDER BY LEAVES_APPLICATION.emp_id DESC LIMIT $start_from,".$results_perpage;  
        $search_result = filterTable($searchquery);
...
if (isset($_POST['searchbydate_btn'])){
  ...
  $searchquery = "SELECT LEAVES_APPLICATION.*, employees.* from employees, LEAVES_APPLICATION  WHERE LEAVES_APPLICATION.leave_datestart = '$datesearch' AND LEAVES_APPLICATION.leave_status = 'Rejected' AND employees.emp_id = LEAVES_APPLICATION.emp_id ORDER BY LEAVES_APPLICATION.emp_id DESC LIMIT $start_from,".$results_perpage;  
  $search_result = filterTable($searchquery);

}

$countdataqry = "SELECT COUNT(emp_id) AS total FROM LEAVES_APPLICATION WHERE leave_status = 'Rejected'";
        ...
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs" id="myTab">
              ...
              <li><a href="adminLEAVESApproved.php"><i class="icon-calendar"></i> Approved</a></li>
              <li  class="active"><a href="adminLEAVESRejected.php"><i class="icon-calendar"></i> Rejected</a></li>
            </ul>
          </div>
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
              ...
              <div class = "row-fluid">
                <div class = "span2">
                  <div id ="search">
                    <form action="adminLeavesRejected.php" method = "post">
                ...
                <div class = "span5">
                  <a href ="adminLeavesRejected.php" class = "btn btn-success" style = "float:right; margin-left: 4px;"><span class="icon"><i class="icon-refresh"></i></span> Refresh</a>
                  <small></small>
                </div>
