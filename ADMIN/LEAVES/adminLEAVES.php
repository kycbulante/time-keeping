...
<div class ="span1">
        ...
        <ul class="nav nav-list">
          ...
          <!-- Add other sidebar items as needed -->
              ...
              <!-- <a href="printleaves.php?printAll" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print All Masterlist</a>
    <a href="printleaves.php?printDisplayed" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print Displayed Masterlist</a> -->
...
<div class ="row-fluid">
     <!-- <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> -->
            <!-- <ul class="nav nav-tabs" id="myTab"> -->
              <!-- <li class="active"><a href="adminLEAVES.php"><i class="icon-calendar"></i> For Approval</a></li> -->
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
                ...
                <div class = "span5">
                  <a href ="adminLeaves.php" class = "btn btn-success" style = "float:right; margin-left: 4px;"><span class="icon"><i class="icon-refresh"></i></span> Refresh</a>
                  <small></small>
                </div>
