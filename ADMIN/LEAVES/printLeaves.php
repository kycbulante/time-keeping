...
if (isset($_GET['printAll'])) {
    ...
    $query = "SELECT LEAVES_APPLICATION.*, employees.* from employees, LEAVES_APPLICATION  WHERE employees.emp_id = LEAVES_APPLICATION.emp_id";
    ...
    var_dump($_SESSION['printleaves_query']);

    $queryResult = isset($_SESSION['printleaves_query']) ? mysqli_query($conn, $_SESSION['printleaves_query']) : '';
