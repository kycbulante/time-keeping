...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href ="<?php $_SERVER['PHP_SELF'];?>" class="tip-bottom"><i class ="icon-file"></i> Payroll Informations</a></div>
  </div>
...
<div class ="span1">
        ...
        <ul class="nav nav-list">
          ...
          <!-- Add other sidebar items as needed -->
              ...
              <div class="row-fluid">
    <a href="printpayroll.php?printAll" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print All Masterlist</a>
    <a href="printpayroll.php?printDisplayed" class="btn btn-info btn-mini" target="_blank"><span class="icon"><i class="icon-print"></i></span> Print Displayed Masterlist</a>

      <div class = "span10">
        <h3>Payroll Informations</h3>        
      </div>
    </div>
        ...
        <div class="widget-box">
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
              ...
              <div class = "row-fluid">
                ...
                <div class = "span6">
                  <a href ="adminPAYROLLINFO.php" class = "btn btn-success" style = "float:right; margin-left: 4px;"><span class="icon"><i class="icon-refresh"></i></span> Refresh</a>
