...
<div class ="row-fluid">
     <div class="span12">
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs" id="myTab">
              <li><a href="adminGOVTTables.php"><i class="icon-th"></i> SSS</a></li>
              <li class="active"><a href="adminPHILHEALTH.php"><i class="icon-th"></i> Philhealth</a></li>
              <li><a href="adminWITHHOLDINGTAX.php"><i class="icon-th"></i> Withholding Tax</a></li>
            </ul>
          </div>
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
              ...
              <div class = "row-fluid">
                ...
                <div class = "span 10">
                  <center>
                    <img src="philhealthcontributiontable2018.png">
                  </center>
                </div>
                <div class="container-fluid">
    <div class="row-fluid">
...
?>
   ...
   <td><?php echo $row1['philhealth_deduct'];?></td>
 </tr>
<?php endwhile;?>
