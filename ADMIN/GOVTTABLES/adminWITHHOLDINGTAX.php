        ...
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs" id="myTab">
              ...
              <li class="active"><a href="adminWITHHOLDINGTAX.php"><i class="icon-th"></i> Withholding Tax</a></li>
            </ul>
          </div>
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
              ...
              <div class = "row-fluid">
                <center>
                  <h4>TRAIN Withholding Tax Table 2018</h4>
                </center>
              </div> 
              ...
              <div class = "row-fluid">
                ...
                <div class = "span 10">
                  <center>
                    <img src="TRAIN TAX TABLE 2018.jpg">
                  </center>
                </div>
                <div class="container-fluid">
    <div class="row-fluid">
...
?>
   ...
   <td><?php echo $row1['pagibig_deduct'];?></td>
 </tr>
<?php endwhile;?>
