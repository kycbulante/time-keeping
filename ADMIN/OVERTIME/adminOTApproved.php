...
if(isset($_POST['search_btn'])){
  ...
  switch ($searchby) {
    ...
    case "Employee ID":
        ...
        $searchquery = "SELECT OVER_TIME.*, employees.* from employees, OVER_TIME  WHERE employees.emp_id LIKE '%$searchvalue%' AND (OVER_TIME.ot_remarks = 'Approved' OR OVER_TIME.ot_remarks = 'Allowed') AND employees.emp_id = OVER_TIME.emp_id ORDER BY OVER_TIME.emp_id DESC LIMIT $start_from,".$results_perpage;  
    ...
    case "Last Name":
        ...
        $start_from = ($page-1) * $results_perpage;
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT OVER_TIME.*, employees.* from employees, OVER_TIME  WHERE employees.last_name LIKE '%$searchvalue%' AND (OVER_TIME.ot_remarks = 'Approved' OR OVER_TIME.ot_remarks = 'Allowed') AND employees.emp_id = OVER_TIME.emp_id ORDER BY OVER_TIME.emp_id DESC LIMIT $start_from,".$results_perpage;  
        $search_result = filterTable($searchquery);
    ...
    break;
     ...
     case "First Name":
        ...
        $start_from = ($page-1) * $results_perpage;
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT OVER_TIME.*, employees.* from employees, OVER_TIME  WHERE employees.first_name LIKE '%$searchvalue%' AND (OVER_TIME.ot_remarks = 'Approved' OR OVER_TIME.ot_remarks = 'Allowed') AND employees.emp_id = OVER_TIME.emp_id ORDER BY OVER_TIME.emp_id DESC LIMIT $start_from,".$results_perpage;  
        $search_result = filterTable($searchquery);
    ...
    case "Username":
        ...
        $start_from = ($page-1) * $results_perpage;
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT OVER_TIME.*, employees.* from employees, OVER_TIME  WHERE employees.user_name LIKE '%$searchvalue%' AND (OVER_TIME.ot_remarks = 'Approved' OR OVER_TIME.ot_remarks = 'Allowed') AND employees.emp_id = OVER_TIME.emp_id ORDER BY OVER_TIME.emp_id DESC LIMIT $start_from,".$results_perpage;  
        $search_result = filterTable($searchquery);
    ...
    case "";
        ...
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT OVER_TIME.*, employees.* from employees, OVER_TIME  WHERE (OVER_TIME.ot_remarks = 'Approved' OR OVER_TIME.ot_remarks = 'Allowed') AND employees.emp_id = OVER_TIME.emp_id ORDER BY OVER_TIME.emp_id";  
        $search_result = filterTable($searchquery);
    ...
    default:
        $searchvalue = $_POST['searchvalue'];
        $searchquery = "SELECT OVER_TIME.*, employees.* from employees, OVER_TIME  WHERE (OVER_TIME.ot_remarks = 'Approved' OR OVER_TIME.ot_remarks = 'Allowed') AND employees.emp_id = OVER_TIME.emp_id ORDER BY OVER_TIME.emp_id DESC LIMIT $start_from,".$results_perpage;  
        $search_result = filterTable($searchquery);
...
if (isset($_POST['searchbydate_btn'])){
  ...
  $searchquery = "SELECT OVER_TIME.*, employees.* from employees, OVER_TIME  WHERE OVER_TIME.ot_day = '$datesearch' AND (OVER_TIME.ot_remarks = 'Approved' OR OVER_TIME.ot_remarks = 'Allowed') AND employees.emp_id = OVER_TIME.emp_id ORDER BY OVER_TIME.emp_id DESC LIMIT $start_from,".$results_perpage;  
  $search_result = filterTable($searchquery);

}

$countdataqry = "SELECT COUNT(emp_id) AS total FROM OVER_TIME WHERE ot_remarks = 'Approved'";
...
<div class ="row-fluid">
     <div class="span12">
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs" id="myTab">
              <li><a href="adminOT.php"><i class="icon-time"></i> For Approval</a></li>
              <li class="active"><a href="adminOTApproved.php"><i class="icon-time"></i> Approved</a></li>
              <li><a href="adminOTRejected.php"><i class="icon-time"></i> Rejected</a></li>
            </ul>
          </div>
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
              ...
              <div class = "row-fluid">
                ...
                <div class = "span5">
                  <a href ="adminOTApproved.php" class = "btn btn-success" style = "float:right; margin-left: 4px;"><span class="icon"><i class="icon-refresh"></i></span> Refresh</a>
                  <small></small>
                </div>
