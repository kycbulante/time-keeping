...
$pdf->Cell(38,7,'MORNING',1,0,'C');
$pdf->Cell(38,7,'AFTERNOON',1,0,'C');
...
$overtimeinout = "SELECT * FROM OVER_TIME WHERE emp_id = '$printid' and ot_day = '$dtrday' and ot_remarks ='Approved'";
...
$pdf->Cell(19,7,$payperiodarray['out_morning'],1,0,'C');
$pdf->Cell(19,7,$payperiodarray['in_afternoon'],1,0,'C');
