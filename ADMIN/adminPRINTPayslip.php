...
$thirteenthmonth = "SELECT * FROM 13thmonth WHERE emp_id = '$printid' AND 13th_year = YEAR('$printfrom')";
...
$row1tot = ($basicpay + $otpay + $rhdaypay+  $otrhpay + $shdaypay + $otshpay + $thirteenth);
