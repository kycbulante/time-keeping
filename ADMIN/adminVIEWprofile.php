...
?><div id="content">
  ...
  <div class="container-fluid">
    <div class = "row-fluid">
      ...
      <span class="span8">
        <h3 class = "userinfo">Employee Information</h3>
      </span>
    </div>
      ...
      <div class ="span8">
        <div class="widget-box">
            ...
            <ul class="nav nav-tabs" id="myTab">
              ...
              <li><a href="adminVIEWPayrollperEmp.php?id=<?php echo $idres;?>"><i class="icon-th"></i> Payroll</a></li>
            </ul>
          </div>
            ...
            <div class ="control-group">
                    <label class="control-label">Search by date: </label>
                      <div class="controls">
                        ...
                        <div id="search">
                        <input class="span8" type="text" id="datepickerfrom" name="dpfrom" placeholder="From" value="<?php echo $datepickerfrom; ?>">
                        </div>
                        <div id = "search">
                        <input class ="span8" type="text" id="datepickerto" name ="dpto" placeholder="To" value="<?php echo $datepickerto;?>"><button type="submit" class = "btn btn-primary" name ="searchbydate_btn"><i class ="icon-search icon-white"></i></button>
                        </div>
