    ...
    <div class ="row-fluid">
     ...
     <!-- <div class="span12">
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs" id="myTab">
              <li class="active"><a href="empAPPLYOvertime.php"><i class="icon-time"></i> For Application</a></li>
          ...
          <div id="tab1" class="tab-pane fade in active"><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB--><!--EMPLOYEE TAB-->
              ...
              <div class = "row-fluid">
                ...
                <div class = "span5">
                  ...
                  <a href ="empAPPLYBeforeOvertime.php?id=<?php echo $currentempid;?>" class = "btn btn-info" style = "float:right; margin-left: 4px;"><span class="icon"><i class="icon-time"></i></span> Apply Overtime</a>
